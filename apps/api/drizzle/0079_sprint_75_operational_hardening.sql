...
ALTER TABLE `social_automation_settings` ADD `per_connection_reply_daily_cap` integer DEFAULT 10 NOT NULL;--> statement-breakpoint
...
ALTER TABLE `publications` ADD `processing_attempts` integer DEFAULT 0 NOT NULL;
