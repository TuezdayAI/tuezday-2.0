...
> **Integration note (2026-07-31):** The branch originally authored its three
> data migrations as `0056`–`0058`. Remote `main` subsequently assigned `0056`
> to the chat/copilot schema migration, so the final integration regenerates
> the Sprint 50 chain as `0057`–`0059`. Historical task steps below retain the
> branch-local numbers they were executed with.
